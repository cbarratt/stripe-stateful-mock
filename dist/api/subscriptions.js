...
(function (subscriptions) {
    ...
    function create(accountId, params) {
        ...
        const subscriptionId = params.id || `sub_${(0, utils_1.generateId)(14)}`;
        ...
        const subscription = {
            ...
            latest_invoice: `in_${(0, utils_1.generateId)(14)}`,
            livemode: false,
    ...
    function createItem(accountId, item, subscriptionId) {
        ...
        const subItemId = paramId || `si_${(0, utils_1.generateId)(14)}`;
        const subscriptionItem = {
            ...
            deleted: undefined,
            metadata: (0, utils_1.stringifyMetadata)(item.metadata),
    ...
    function list(accountId, params) {
        ...
        return (0, utils_1.applyListOptions)(data, params, (id, paramName) => {
