...
(function (charges) {
    ...
    function create(accountId, params) {
        ...
        if (typeof params.customer === "string") {
            ...
            if ((0, sourceTokenChains_1.isSourceTokenChain)(sourceToken)) {
                sourceToken = (0, sourceTokenChains_1.getEffectiveSourceTokenFromChain)(sourceToken);
            }
    ...
    function update(accountId, chargeId, params) {
        ...
        if (params.metadata !== undefined) {
            charge.metadata = (0, utils_1.stringifyMetadata)(params.metadata);
        }
    ...
    function capture(accountId, chargeId, params) {
        ...
        charge.balance_transaction = "txn_" + (0, utils_1.generateId)(24);
        return charge;
    }
    charges.capture = capture;
    function getChargeFromCard(params, source) {
        const chargeId = "ch_" + (0, utils_1.generateId)();
        ...
        return {
            ...
            balance_transaction: params.capture !== "false" ? "txn_" + (0, utils_1.generateId)(24) : null,
            billing_details: {
                address: {
                    city: null,
                    country: null,
            ...
            paid: true,
            payment_intent: null,
            payment_method: "card_" + (0, utils_1.generateId)(24),
            payment_method_details: {
                card: {
                    ...
                    fingerprint: (0, utils_1.generateId)(16),
            ...
            receipt_number: null,
            receipt_url: `https://pay.stripe.com/receipts/acct_${(0, utils_1.generateId)(16)}/${chargeId}/rcpt_${(0, utils_1.generateId)(32)}`,
            refunded: false,
            refunds: {
                object: "list",
                data: [],
