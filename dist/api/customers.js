...
(function (customers) {
    ...
    function create(accountId, params) {
        ...
        const customerId = params.id || `cus_${(0, utils_1.generateId)(14)}`;
        const customer = {
            id: customerId,
            object: "customer",
            ...
            invoice_prefix: params.invoice_prefix || (0, utils_1.generateId)(7),
            invoice_settings: {
                custom_fields: null,
        ...
        return (0, utils_1.expandObject)(customer, ["sources", "subscriptions"], params.expand);
    }
    ...
    function update(accountId, customerId, params) {
        ...
        if (params.metadata !== undefined) {
            customer.metadata = (0, utils_1.stringifyMetadata)(params.metadata);
        }
